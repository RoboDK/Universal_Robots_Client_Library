...
bool ScriptCommandInterface::setTcp(const vector6d_t* frame)
{
  ...
  {
    val = htobe32(static_cast<int32_t>(round(component * MULT_JOINTSTATE)));
    b_pos += append(b_pos, val);
  }
